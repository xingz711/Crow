...
Va_XeVa2BRate::Va_XeVa2BRate(const InputParameters & parameters) :
    Kernel(parameters),
...
Real
Va_XeVa2BRate::computeQpResidual()
{

  //Reaction: XeVa + Va <-> XeVaVa
  ...
  // Concentration terms
  Real DF = (_EBXeVa2B[_qp] - _kT[_qp] * (_SBXeVa2B[_qp]) + _kT[_qp] * MathUtils::poly4Log(_c6[_qp],tol,0)
  ...
  RealGradient DF2 = (_kappa_cgvv[_qp] * _grad_c6[_qp]
                      ...
                      - _kappa_cv[_qp]*_grad_u[_qp]);

  R1 = -_test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R2 = -_test[_i][_qp] * (-_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R21 = -_grad_test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);

  R22 = -_grad_test[_i][_qp] * (-_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);
...
Real
Va_XeVa2BRate::computeQpJacobian()
{
  const Real tol = _LogTol[_qp];
  ...
  // Gradient terms
  RealGradient DF2 = (_kappa_cgvv[_qp] * _grad_u[_qp]
                      - _kappa_cgv[_qp] * _grad_c3[_qp]
                      - _kappa_cv[_qp]*_grad_u[_qp]);

  R1a = _test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R21a = _grad_test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);

  R1 = -(_test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp]
                           * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1) * _phi[_j][_qp]))
         + _test[_i][_qp] * (_c3[_qp] * _phi[_j][_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF));

  R2 = -(_test[_i][_qp] * (-_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp]
                           * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1) * _phi[_j][_qp]))
         + _test[_i][_qp] * (-_c3[_qp] * _phi[_j][_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF));

  R21 = -(_grad_test[_i][_qp] * (_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp])
          * (-_kappa_cv[_qp] * _grad_phi[_j][_qp]) + _grad_test[_i][_qp]
          * (_c3[_qp] * _phi[_j][_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2));

  R22 = -(_grad_test[_i][_qp] * (-_c3[_qp] * _u[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp])
          * (-_kappa_cv[_qp] * _grad_phi[_j][_qp]) + _grad_test[_i][_qp]
          * (-_c3[_qp] * _phi[_j][_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp]*DF2));
