#ifndef UO2ANISOCONSTEMPXEUVA_H
#define UO2ANISOCONSTEMPXEUVA_H

#include "Material.h"

//Forward Declarations
class UO2AnisoConsTempXeUVa;

template<>
InputParameters validParams<UO2AnisoConsTempXeUVa>();

class UO2AnisoConsTempXeUVa : public Material
{
public:
  UO2AnisoConsTempXeUVa(const InputParameters & parameters);
