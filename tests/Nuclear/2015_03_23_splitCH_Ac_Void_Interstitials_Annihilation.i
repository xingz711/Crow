...
[Kernels]
  active = 'AC_int e_dot cv_dot CH_noise CHi_noise ci_res AC_bulk wi_res VacancyAhhihilation cv_res wv_res InterstitialsAhhihilation ci_dot'
  [./cv_dot]
...
[Outputs]
  ...
  tecplot = true
  file_base = Void_Interstitial_Annihilation
  csv = true
  [./console]
    type = Console
