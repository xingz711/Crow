...
template<>
InputParameters validParams<XeVa_XeVa2BRate>()
{
...
XeVa_XeVa2BRate::XeVa_XeVa2BRate(const InputParameters & parameters) :
    Kernel(parameters),
...
Real
XeVa_XeVa2BRate::computeQpResidual()
{
  ...
  // Concentration terms
  Real DF = (_EBXeVa2B[_qp] - _kT[_qp] * (_SBXeVa2B[_qp])
             + _kT[_qp] * MathUtils::poly4Log(_c6[_qp],tol,0)
  ...
  R1 = -_test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R2 = -_test[_i][_qp] * (-_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R21 = -_grad_test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);

  R22 = -_grad_test[_i][_qp] * (-_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);
...
Real
XeVa_XeVa2BRate::computeQpJacobian()
{
  const Real tol = _LogTol[_qp];
  ...
  R1a = _test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF);

  R21a = _grad_test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2);

  R1 = -(_test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp]
                           * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1) * _phi[_j][_qp]))
         + _test[_i][_qp] * (_phi[_j][_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF));

  R2 = -(_test[_i][_qp] * (-_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp]
                           * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1) * _phi[_j][_qp]))
         + _test[_i][_qp] * (-_phi[_j][_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF));

  R21 = -(_grad_test[_i][_qp] * (_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp])
          * (-_kappa_cgv[_qp] * _grad_phi[_j][_qp])
          + _grad_test[_i][_qp] * (_phi[_j][_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2));

  R22 = -(_grad_test[_i][_qp] * (-_u[_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp])
          * (-_kappa_cgv[_qp] * _grad_phi[_j][_qp])
          + _grad_test[_i][_qp] * (-_phi[_j][_qp] * _c2[_qp] * (_MVa[_qp]/S/S + _MCgVa[_qp]/S/S) * _Zg[_qp] * DF2));
