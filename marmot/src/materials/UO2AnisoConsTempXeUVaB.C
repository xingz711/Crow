...
InputParameters validParams<UO2AnisoConsTempXeUVaB>()
{
  ...
  // c1=cg, c2=cv, c3=cgv, c4=cvv, c6=cgvv
...
UO2AnisoConsTempXeUVaB::UO2AnisoConsTempXeUVaB(const InputParameters & parameters) :
    Material(parameters),
    _c1(coupledValue("c1")),
    _c2(coupledValue("c2")),
    _c3(coupledValue("c3")),
...
void
UO2AnisoConsTempXeUVaB::computeProperties()
{

  //Materils file for Xe, Va, XeVa, VaVa, UI, XeVaVa system, but XeVaVa is not treated as mobile (incorrect and no longer used)

  Real vC_i[] = { 3.55, 3.55, 0.64, 0.64, 4.79, 4.79 };
  Real vm_i[] = { 0.872, 0.872, 0.346, 0.346, 0.954, 0.954 };
  Real vb_i[] = { -0.444, -0.444, -0.278, -0.278, 1.485, 1.485 };
  Real gbw_i[] = { 3.704, 3.704, 4.128, 4.128, 3.642, 3.642 };

  // For vacancies
  Real vVaC_i[] = { 3.56, 3.56, 1.23, 1.23, 4.80, 4.80 };
  Real vVam_i[] = { 1.40287, 1.40287, 0.31681, 0.31681, 0.856, 0.856 };
  Real vVab_i[] = { -2.76788, -2.76788, 0.11084, 0.11084, 1.78, 1.78 };

  // For inersttials
  Real vUIC_i[] = { 3.56, 3.56, 1.23, 1.23, 4.80, 4.80 };
  Real vUIm_i[] = { 1.40287, 1.40287, 0.31681, 0.31681, 0.856, 0.856 };
  Real vUIb_i[] = { -2.76788, -2.76788, 0.11084, 0.11084, 1.78, 1.78 };
  ...
  for (_qp = 0; _qp < _qrule->n_points(); ++_qp)
  {
    ...
    Real DH = DH0;
    RealGradient grad_DH = 0.0;
    Real DHV = DHV0;
    RealGradient grad_DHV = 0.0;
    Real DHV2 = DHV20;
    RealGradient grad_DHV2 = 0.0;
    Real DHI = DHI0;
    RealGradient grad_DHI = 0.0;
    ...
    _cu[_qp] = 1.0 - _c1[_qp] - _c2[_qp] - 2.0 * _c3[_qp] - 2.0 * _c4[_qp] - 3.0 * _c6[_qp];
    _grad_cu[_qp] = -_grad_c1[_qp] - _grad_c2[_qp]
                    - 2.0 * _grad_c3[_qp] - 2.0 * _grad_c4[_qp]
                    - 3.0 * _grad_c6[_qp];
