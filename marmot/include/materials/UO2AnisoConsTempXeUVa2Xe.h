#ifndef UO2ANISOCONSTEMPXEUVA2Xe_H
#define UO2ANISOCONSTEMPXEUVA2Xe_H

#include "Material.h"

//Forward Declarations
class UO2AnisoConsTempXeUVa2Xe;

template<>
InputParameters validParams<UO2AnisoConsTempXeUVa2Xe>();

class UO2AnisoConsTempXeUVa2Xe : public Material
{
public:
  UO2AnisoConsTempXeUVa2Xe(const InputParameters & parameters);
...
private:
  ...
  MaterialProperty<Real> & _EBgXeXeVa;
  MaterialProperty<Real> & _EBgXeVaXeVa;
  ...
  MaterialProperty<Real> & _SBgXeXeVa;
  MaterialProperty<Real> & _SBgXeVaXeVa;
  //  MaterialProperty<RealGradient> & _grad_EBXeVa;
  ...
  MaterialProperty<Real> & _Dggv;
  MaterialProperty<Real> & _Mggv;
  MaterialProperty<RealGradient> & _grad_Mggv;
  ...
  MaterialProperty<Real> & _kappa_cGGV;
  MaterialProperty<Real> & _kappa_cGGVU;
