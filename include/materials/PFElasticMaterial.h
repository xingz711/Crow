...
#ifndef PFELASTICMATERIAL_H
#define PFELASTICMATERIAL_H
 ...
 * cubic, etc as needed.
 */
class PFElasticMaterial : public TensorMechanicsMaterial
{
public:
  PFElasticMaterial(const std::string & name, InputParameters parameters);
