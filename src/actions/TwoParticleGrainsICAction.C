...
TwoParticleGrainsICAction::TwoParticleGrainsICAction(InputParameters params) :
    Action(params),
...
TwoParticleGrainsICAction::act()
{
  ...
  for (unsigned int op = 0; op < _op_num; op++)
  {
    ...
    InputParameters poly_params = _factory.getValidParams("TwoParticleGrainsIC");
    ...
    _problem->addInitialCondition("TwoParticleGrainsIC", "InitialCondition", poly_params);
  }
}
