...
#ifndef BICRYSTALIC_H
#define BICRYSTALIC_H
...
/**
 * BicrystalIC allows setting the initial condition of a value inside and outside of a specified box.
 ...
 */
class BicrystalIC : public InitialCondition
{
public:
