#ifndef XE_XEVA2_BRATE_H
#define XE_XEVA2_BRATE_H

#include "Kernel.h"
#include "Material.h"

//Forward Declarations
class Xe_XeVa2_BRate;

template<>
InputParameters validParams<Xe_XeVa2_BRate>();

class Xe_XeVa2_BRate : public Kernel
{
public:
  Xe_XeVa2_BRate(const InputParameters & parameters);
