...
[Kernels]
  active = 'AC_int w_res c_dot e_dot c_res CH_noise ci_res AC_bulk wi_res CH_Pv_rand ci_dot cv_recomb ints_noise'
  [./c_dot]
...
[Materials]
  active = 'AC_mat Vacancy_en switching_function barrier_function Mob free_en Energy_matrix mob_ci'
  [./Energy_matrix]
  ...
  [./AC_mat]
    ...
    block = 0
    prop_names = 'L kappa_op kappa_c mask '
