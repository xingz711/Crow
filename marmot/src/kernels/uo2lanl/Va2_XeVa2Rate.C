...
InputParameters validParams<Va2_XeVa2Rate>()
{
  ...
  params.addParam<std::string>("mob_name3", "MVa", "Va mobility");
...
Va2_XeVa2Rate::Va2_XeVa2Rate(const InputParameters & parameters) :
    Kernel(parameters),
    ...
    _mob_name3(getParam<std::string>("mob_name3")),
    _MVa(getMaterialProperty<Real>(_mob_name3)),
    _c1(coupledValue("c1")),
...
Real
Va2_XeVa2Rate::computeQpResidual()
{
  ...
  // Concentration terms
  Real DF =   _EBXeVa[_qp] - _EBVaVa[_qp]
              - _kT[_qp] * (_SBXeVa[_qp] - _SBVaVa[_qp])
  ...
  // Gradient terms
  RealGradient DF2 = (_kappa_cgv[_qp] * _grad_c3[_qp] + _kappa_cv[_qp] * _grad_c2[_qp]
                      - _kappa_cg[_qp] * _grad_c1[_qp] - _kappa_cvv[_qp] * _grad_u[_qp]);

  R1 = -_test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF);

  R2 = -_test[_i][_qp] * (-_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF);

  R21 = -_grad_test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF2);

  R22 = -_grad_test[_i][_qp] * (-_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF2);
...
Real
Va2_XeVa2Rate::computeQpJacobian()
{
  const Real tol = _LogTol[_qp];
  ...
  R1a = -_test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF);

  R21a = -_grad_test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF2);

  R1 = -_test[_i][_qp] * (_c1[_qp] * _phi[_j][_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp]
                          * (_EBXeVa[_qp] - _EBVaVa[_qp] - _kT[_qp] * (_SBXeVa[_qp] - _SBVaVa[_qp])
       ...
       - _test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1) * _phi[_j][_qp]));

  R2 = -_test[_i][_qp] * (-_c1[_qp] * _phi[_j][_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp]
                          * (_EBXeVa[_qp] - _EBVaVa[_qp] - _kT[_qp] * (_SBXeVa[_qp] - _SBVaVa[_qp])
                             + _kT[_qp] * MathUtils::poly4Log(_c3[_qp],tol,0) + _kT[_qp] * MathUtils::poly4Log(_c2[_qp],tol,0)
                             - _kT[_qp] * MathUtils::poly4Log(_c1[_qp],tol,0) - _kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,0)))
       - _test[_i][_qp] * (-_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * (-_kT[_qp] * MathUtils::poly4Log(_u[_qp],tol,1)*_phi[_j][_qp]));

  R21 = -_grad_test[_i][_qp] * (_c1[_qp] * _phi[_j][_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF2)
        - _grad_test[_i][_qp] * (_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp]
                                 * (-_kappa_cvv[_qp] * _grad_phi[_j][_qp]));

  R22 = -_grad_test[_i][_qp] * (-_c1[_qp] * _phi[_j][_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp] * DF2)
        - _grad_test[_i][_qp] * (-_c1[_qp] * _u[_qp] * (_MVa2[_qp]/S/S) * _Zg[_qp]
                                 * (-_kappa_cvv[_qp] * _grad_phi[_j][_qp]));
