...
[AuxVariables]
  active = 'C2222 e22 e11 S11 S22 T total_en C1111 ElasticEn'
  [./bnds]
  [../]
  [./total_en]
    order = CONSTANT
...
[Kernels]
  active = 'TensorMechanics wres cres time'
  [./cres]
    type = SplitCHParsed
    variable = c
    kappa_name = kappa_c
...
[Materials]
  active = 'stress temp Elstc_en ElasticityTensor sum CH_mat strain free_energy'
  [./constant]
    type = PFMobility
    block = 0
    mob = 1.0
...
[Postprocessors]
  active = 'load temp mat_D e11 elem_c s11 s22 e22'
  [./mat_D]
