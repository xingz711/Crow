...
XeXeVaRate::XeXeVaRate(const InputParameters & parameters) :
    Kernel(parameters),
...
XeXeVaRate::computeQpResidual()
{
  ...
  // Gradient terms
  RealGradient DF2 = (_kappa_cggv[_qp] * _grad_u[_qp]
...
XeXeVaRate::computeQpJacobian()
{
  ...
  R21 = _grad_test[_i][_qp] * (_c1[_qp] * _c6[_qp] * (_MXeXe[_qp]/S/S)
                               * _Zg[_qp]) * (_kappa_cggv[_qp]*_grad_phi[_j][_qp]);

  R22 = _grad_test[_i][_qp] * (-_c1[_qp] * _c6[_qp] * (_MXeXe[_qp]/S/S)
                               * _Zg[_qp]) * (_kappa_cggv[_qp] * _grad_phi[_j][_qp]);
