...
class MultiSmoothParticleIC;

template<>
InputParameters validParams<MultiSmoothParticleIC>();

/**
 * MultismoothParticleIC creates multiple SmoothCircles (number = numbub) that are randomly
 * positioned around the domain, with a minimum spacing equal to bubspac
 **/
class MultiSmoothParticleIC : public SmoothCircleBaseIC
{
public:
  /**
   * Constructor
   ...
   */
  MultiSmoothParticleIC(const InputParameters & parameters);
