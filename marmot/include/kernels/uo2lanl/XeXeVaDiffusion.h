#ifndef XEXEVADIFFUSION_H
#define XEXEVADIFFUSION_H

#include "CHBulk.h"

//Forward Declarations
class XeXeVaDiffusion;

template<>
InputParameters validParams<XeXeVaDiffusion>();

class XeXeVaDiffusion : public CHBulk
{
public:
  XeXeVaDiffusion(const InputParameters & parameters);
