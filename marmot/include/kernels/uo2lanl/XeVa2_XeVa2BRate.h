#ifndef XEVA2_XEVA2BRATE_H
#define XEVA2_XEVA2BRATE_H

#include "Kernel.h"

//Forward Declarations
class XeVa2_XeVa2BRate;

template<>
InputParameters validParams<XeVa2_XeVa2BRate>();

class XeVa2_XeVa2BRate : public Kernel
{
public:
  XeVa2_XeVa2BRate(const InputParameters & parameters);
