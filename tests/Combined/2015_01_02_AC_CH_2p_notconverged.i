...
[Mesh]
  ...
  xmax = 40 # maximum x-coordinate of the mesh
  ymax = 40 # maximum y-coordinate of the mesh
  zmax = 0
...
[Materials]
  [./CuGrGr]
    # Material properties
    type = GenericConstantMaterial # Quantitative material properties for copper grain growth.  Dimensions are nm and ns
