...
template<>
InputParameters validParams<UO2AnisoConsTempXeUVa>()
{
  ...
  params.addRequiredParam<Real>("HI", "U interstitial barrier in eV");
...
UO2AnisoConsTempXeUVa::UO2AnisoConsTempXeUVa(const InputParameters & parameters) :
    Material(parameters),
    _c1(coupledValue("c1")),
    _c2(coupledValue("c2")),
    _c3(coupledValue("c3")),
...
void
UO2AnisoConsTempXeUVa::computeProperties()
{

  //Materils file for Xe, Va, XeVa, VaVa, UI system
  ...
  for (_qp = 0; _qp < _qrule->n_points(); ++_qp)
  {
    ...
    _cu[_qp]=1-_c1[_qp]-_c2[_qp]-2*_c3[_qp]-2*_c4[_qp];
    _grad_cu[_qp]=-_grad_c1[_qp]-_grad_c2[_qp]-2*_grad_c3[_qp]-2*_grad_c4[_qp];
