#ifndef XEVA_XEVA2BRATE_H
#define XEVA_XEVA2BRATE_H

#include "Kernel.h"

//Forward Declarations
class XeVa_XeVa2BRate;

template<>
InputParameters validParams<XeVa_XeVa2BRate>();

class XeVa_XeVa2BRate : public Kernel
{
public:
  XeVa_XeVa2BRate(const InputParameters & parameters);
